...
var _default = function _default(props) {
  ...
  var _useState5 = (0, _react.useState)({
    ...
    imageInfo = _useState6[0],
    setImageInfo = _useState6[1];
  ...
  return /*#__PURE__*/ _react.default.createElement(
    'div',
    {
      className: ''.concat(prefixCls, '-image-slide'),
      style: {
        transform: 'translate(calc('.concat(-100 * (index - site), '%), 0'),
      },
    },
    /*#__PURE__*/ _react.default.createElement('img', {
      ...
      className: (0, _classnames3.default)(
        ...
        (0, _defineProperty2.default)({}, ''.concat(prefixCls, '-loading'), loading),
